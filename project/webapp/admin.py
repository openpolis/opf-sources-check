...
from .models import Content, Recipient
...
class ContentAdmin(admin.ModelAdmin):    
  ...
  def _linked_title(self, obj):
    return '%s <a href="%s" target="_blank"><img src="/static/images/extlink.gif" alt="vai" title="vai alla url: %s"</a>' % (obj.title, obj.url, obj.url)
  ...
  def _status_and_message(self, obj):
    ...
    if obj.verification_status == 0:
      ...
      msg = 'CAMBIATO - <a href="/diff/%s"><img src="/static/images/extlink.gif" alt="vai"/> visualizza le differenze</a>' % obj.id
    else:
