...
PROJECT_NAME = "Openpolis Sources Check" or PACKAGE_NAME
PROJECT_PACKAGE = "webapp" or PACKAGE_NAME

REPO_PATH = dirname(PROJECT_PATH)
REPO_NAME = "opf-sources-check" or basename(REPO_PATH)
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': normpath(join(RESOURCES_PATH, 'logs', 'opf-sources-check.log')),
